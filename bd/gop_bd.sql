...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-07-2015 a las 00:08:29
...
(1, 'Cancha ejemplo', 'Loja', 12, '-4.3651522', '-79.1999994', 25),
(2, 'Cancha Sintética de la UTPL', 'Instalaciones de la Universidad Técnica Particular de Loja', 18, '-4.032945', '-79.202649', 0),
(3, 'La pampita', 'Av. Orillas del Zamora, Loja', 12, '-3.977599', '-79.202093', 25),
(4, 'Punto Sport', 'Azuay 11-18 y Juan JosÃ© PeÃ±a', 8, '-4.0002533', '-79.1987175', 18),
(5, 'Maxfutbol', 'Av. 8 de Diciembre y Jaime Roldos Aguilera (Redondel de las Pitas), Loja', 12, '-3.9695182', '-79.2076872', 20),
(6, 'Cancha Sintetica "La Isla"', 'La isla Y Puerto Rico, Quito', 14, '-3.9867941', '-79.1990528', 25);
...
(1, 'esquezada1', 'jncorrea', 'hola', '2015-07-21 17:03:47', 1),
(2, 'jncorrea', 'esquezada1', 'hola', '2015-07-21 17:04:13', 1);
...
(8, 'hola lola', 'esquezada1994@gmail.com');
...
('esquezada1@utpl.edu.ec', '123', 'esquezada1', 'Edgar', 'Quezada', '0990128372', '', 'user.jpeg', 0),
