<?php 
	...
	echo '<script>
    		...
    		create("default", { color:"background:rgba(16,122,43,0.8);", enlace:"#" ,title:"Notificaci&oacute;n", text:"'.$_POST['fecha_actual'].'", imagen:"../assets/img/check.png"}); 
    	</script>';
	...
	if ($flag[0]==0) { 
		...
		if ($a[0]==1) {
				...
				echo '<script>
					$container = $("#container_notify").notify();    
            		create("default", { color:"background:rgba(16,122,43,0.8);", enlace:"#" ,title:"Notificaci&oacute;n", text:"'.$sql.'", imagen:"../assets/img/check.png"}); 
	        		$("#col_grupos").load("grupos.php?id='.$lista[1].'");
		    	</script>';
			    }else{
			    	echo '<script>
