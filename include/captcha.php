...
$captchaImage = imagecreatefrompng( "../assets/img/captcha.png" );
...
$imageInfo = getimagesize( "../assets/img/captcha.png" );
...
imagettftext( $captchaImage, 20, 0, 35, 35, $textColor, "../assets/fonts/VeraBd.ttf", $key );
