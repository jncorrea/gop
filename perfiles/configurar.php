		...
		<div class="modal-dialog">
		 <div class="modal-content">
		  <div class="modal-header">
		   ...
		   <h4 class="modal-title" id="nom_partido">Video Introductorio</h4>
		  </div>
		  <div class="modal-body">
		    <iframe width="560" height="315" src="https://www.youtube.com/embed/AjXkydRVs3s" frameborder="0" allowfullscreen></iframe>
		  </div>
